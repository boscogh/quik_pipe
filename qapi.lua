...
а так же получение свечи. В качестве параметров принимаются код класса и код бумаги.
Для свечи в качестве параметров кроме этого еще принимаются период и порядковый номер свечи с конца.
